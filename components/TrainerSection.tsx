...
const trainers = [
  ...
  },
  {
    name: "Nishant Sharma",
    role: "",
    experience: "driving AI product strategy & aligning tech with real business ROI. Ex-IIT Roorkee",
    bio: "Ensures AI adoption aligns with organizational values, managing the lifecycle from concept to client adoption.",
    institution: "AI Product Strategist",
...
export const TrainerSection: React.FC = () => {
  return (
    <section id="trainer-section" className="py-24 bg-black relative border-t border-white/5">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">About Our Trainers</h2>
            ...
            <div key={idx} className="group relative bg-slate-900/40 border border-white/10 rounded-3xl p-6 sm:p-8 hover:bg-slate-900 hover:border-brand-500/30 transition-all duration-300 overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="flex items-center gap-6 mb-8">
                         ...
                         <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl border border-slate-700 overflow-hidden group-hover:border-brand-500/50 transition-colors shadow-lg bg-slate-800">
                            <img 
                              ...
                              onError={(e) => {
                                ...
                                e.currentTarget.src = 'https://via.placeholder.com/150?text=Trainer';
                              }}
                            />
                         </div>
                         <a 
                      ...
                      {/* Name & Role */}
                      <div>
                          <h3 className="text-xl sm:text-2xl font-bold text-white mb-1 group-hover:text-brand-100 transition-colors">{trainer.name}</h3>
                          <p className="text-brand-400 font-medium text-sm mb-3">{trainer.role}</p>
