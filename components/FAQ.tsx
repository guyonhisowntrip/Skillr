  ...
  },
  {
    ...
    a: (
      <ul className="list-disc pl-5 space-y-2">
        <li><strong>Kickoff Weekend:</strong> ~10 hours total</li>
        <li><strong>Build Sprint (2 weeks):</strong> Flexible, self-paced</li>
        <li><strong>Mentorship Clinics:</strong> Short sessions on alternate days</li>
      </ul>
    )
  },
  {
